...
master_data = pd.read_csv("./Data/cars24.csv") #Importing master data
...
if (st.button("Predict Price")): #If the Button is clicked
    ...
    st.text("Predicted Price for given inputs based on the below Training Data is: "+ str(price)+" Lakhs") #Display the Price on the webpage
